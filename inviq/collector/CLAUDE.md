...
This is the Collector API, an ingress service responsible for receiving new invoice ticket processing requests. The API handles:

- Ticket numbers (Service Now tickets)
- File lists (files attached to original emails)
