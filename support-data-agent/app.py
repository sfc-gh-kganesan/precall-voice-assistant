...
def main():
    ...
    if "session" not in st.session_state:
        try:
            ...
            st.info(
                "Please ensure your Snowflake connection is configured properly (environment variables, config file, etc.)"
            )
            st.stop()

    # Always show the VOC page interface
    voc_page = VOC()
    voc_page.print_page()
