...
export const metadata: Metadata = {
  title: "AgentSim - AI Agent Testing Platform",
  description: "Evaluate and improve your AI agents",
}
              ...
              <div className="flex justify-between h-16">
                <div className="flex">
                  <Link href="/" className="flex items-center">
                    <span className="text-xl font-serif font-semibold text-parchment-100 tracking-wide">AgentSim</span>
                  </Link>
