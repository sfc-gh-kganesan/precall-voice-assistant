      ...
      >
        ...
        <div className="sticky top-0 bg-navy-950 border-b border-navy-800 px-6 py-4 flex justify-between items-start z-10">
          <div>
            ...
            <p className="text-sm text-text-tertiary mt-2">{knowledgeRec.title}</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-4 space-y-6">
          ...
          <div className="flex gap-4 flex-wrap">
            <div>
              <span className="text-xs text-text-muted">Documentation Type:</span>
          ...
          {/* Target Document */}
          <div>
            <h4 className="text-sm font-semibold text-text-secondary mb-2">Target Document</h4>
            <div className="bg-navy-900/50 px-4 py-3 rounded border border-navy-800">
          ...
          {knowledgeRec.existing_doc_coverage && (
            <div>
              <h4 className="text-sm font-semibold text-text-secondary mb-2">Current Documentation Coverage</h4>
              <div className="bg-navy-900/50 px-4 py-3 rounded border border-navy-800">
                <p className="text-sm text-text-tertiary">{knowledgeRec.existing_doc_coverage}</p>
              </div>
            </div>
          )}
          ...
          {/* Rationale */}
          <div>
            <h4 className="text-sm font-semibold text-text-secondary mb-2">Rationale</h4>
            <div className="bg-navy-900/50 px-4 py-3 rounded border border-navy-800">
              <p className="text-sm text-text-tertiary">{knowledgeRec.rationale}</p>
            </div>
          </div>

          {/* Recommended Content */}
          <div>
            <h4 className="text-sm font-semibold text-text-secondary mb-2">Recommended Content</h4>
            <div className="border border-navy-800 rounded-lg overflow-hidden">
              {/* Header */}
              <div className="bg-navy-900/50 px-4 py-2 border-b border-navy-800 flex justify-between items-center">
                ...
                <button
                  ...
                  className="text-xs text-cyan-400 hover:text-strategic-400 transition-colors"
                >
                  📋 Copy
                </button>
              </div>
              {/* Content */}
              <div className="bg-navy-900 p-4 max-h-96 overflow-y-auto">
        ...
        <div className="sticky bottom-0 bg-navy-950 border-t border-navy-800 px-6 py-4 flex justify-end gap-3">
          ...
          <button
            ...
            className="px-4 py-2 text-sm bg-cyan-500 text-white rounded hover:bg-cyan-400 transition-colors flex items-center gap-2"
          >
            📋 Copy Content
          </button>
        </div>
