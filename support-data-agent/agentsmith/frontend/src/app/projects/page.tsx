...
export default function ProjectsPage() {
  ...
  if (loading) {
    return <div className="p-8 text-center text-parchment-200">Loading deployments...</div>
  }
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-2xl font-serif font-semibold text-parchment-100">Deployments</h1>
      ...
      <div className="mt-8 flow-root">
        {projects.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-parchment-200">No deployments yet. Create your first deployment to get started!</p>
          </div>
        ) : (
