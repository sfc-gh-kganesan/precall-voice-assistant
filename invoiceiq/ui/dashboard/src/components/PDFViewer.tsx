...
import { reprocessInvoice, updateInvoiceFields, updateInvoiceStatus } from '../services/api';
...
export function PDFViewer({ invoice, isOpen, onClose, onUpdateStatus, onRefresh }: PDFViewerProps) {
  ...
  }: { sectionId: string; title: string; color?: string; bgColor?: string }) => (
                ...
                <div className="p-3 bg-gradient-to-br from-[var(--snowflake-blue)]/10 via-[var(--snowflake-teal)]/10 to-blue-50 border border-[var(--snowflake-blue)]/30 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                  ...
                  {displayInvoice.aiProcessedAt && (
                    <div>
                      ...
                      <p className="text-xs">
                        {new Date(displayInvoice.aiProcessedAt).toLocaleString()}
                      </p>
                    </div>
                  )}
                </div>
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {displayInvoice.lastEditedAt
                          ? new Date(displayInvoice.lastEditedAt).toLocaleString()
                          : 'N/A'}
                      </p>
                    </div>
                  </div>
