...
// Node 1: Initialize
async function nodeOne(_: typeof StateAnnotation.State) {
...
// Node 2: Process
async function nodeTwo(_: typeof StateAnnotation.State) {
...
// Node 3: Finalize
async function nodeThree(_: typeof StateAnnotation.State) {
